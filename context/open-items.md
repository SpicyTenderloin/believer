...
- [ ] Custom power distribution board (`docs/engineering/requirements/power-distribution-board-requirements.md`): purpose of 2 of the 4 XT60 output ports beyond the two motors, firm max size/weight envelope, decoupling capacitor sizing and current-sense range (both depend on the still-unresolved ESC model), ESC input connector type, and environmental operating range are all open - see that document's Section 5
