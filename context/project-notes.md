...
- **GPS_2** (`GPS_2_GNSS = 29`): SparkFun GPS-RTK-SMA Breakout - ZED-F9P, connected to the Pixhawk's GPS 2 UART port. External mount and antenna installed 2026-08-28 (`docs/project/build-checklist.md` NAV-03/NAV-04). RTK correction source still TBD; `GPS_2_CONFIG` remains disabled pending protocol/GNSS configuration and GPS lock confirmation (NAV-05).
