...
- **Motors**: T-Motor U5 v2.0, KV400, one per wing (MAIN 4 = left, MAIN 6 = right). 12N14P configuration, 5mm shaft, 156g (excl. cables), 3-8S LiPo, max 30A / 850W continuous (180s). No official PDF datasheet - specs from T-Motor product page only. Replacement purchased 2026-07-06: 2x T-Motor MN3110 KV700 (Julian personal funds, $169.87 AUD, T-MOTOR Official Store via Alibaba.com) - not yet installed, see `docs/build-checklist.md`.
