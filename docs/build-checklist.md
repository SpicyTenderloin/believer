...
| Configure and Tune | Motor start synchronisation | One motor starts before the other on throttle-up; root cause confirmed as ESC calibration (Peter Spink, TMAC, 2026-07-10) - to be recalibrated via QGroundControl as part of the new motor installation | Urgent |
