...
| Configure and Tune | Install T-MOTOR MN3110 KV700 motors | Fit the newly purchased motors in place of the T-Motor U5 v2.0 KV400 units; confirm ESC compatibility, and re-verify motor spin directions and PWM mapping after installation | Critical |
